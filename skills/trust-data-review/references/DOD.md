...
At the end of your execution, append the following block to your output (or write it as `<run-dir>/agents/data.dod.json`):
...
The orchestrator reads `data.dod.json` and:
