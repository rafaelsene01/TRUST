...
At the end of your execution, append the following block to your output (or write it as `<run-dir>/agents/conventions.dod.json`):
...
The orchestrator reads `conventions.dod.json` and:
