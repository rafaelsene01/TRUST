...
At the end of your execution, append the following block to your output (or write it as `<run-dir>/agents/tests.dod.json`):
...
The orchestrator reads `tests.dod.json` and:
