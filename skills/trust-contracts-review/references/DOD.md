...
At the end of your execution, append the following block to your output (or write it as `<run-dir>/agents/contracts.dod.json`):
...
The orchestrator reads `contracts.dod.json` and:
